...
const gameBoard = document.getElementById("quizBoard");
const gameBoardContainer = document.querySelector(".quiz__board");
...
// * Rendering images in the quiz board
...
const createNewQuiz = async () => {
  ...
  startButton.disabled = true; // disables the new quiz button while a quiz is already playing
  inputField.disabled = true; // disables the new quiz button while a quiz is already playing
};

//* event listeners
startButton.addEventListener("click", createNewQuiz);
